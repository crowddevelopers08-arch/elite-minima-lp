/* ============================================================
   ...
   Payload shape (from app/api/leads → lib/sheets.ts):
     {
       timestamp, name, phone, email, address, area (concern), duration,
       callTime, branch, source, medium, campaign, pageUrl, sheetTab
     }
...
var COL_WIDTHS = [175, 160, 130, 200, 220, 200, 140, 150, 150, 130, 130, 150, 300];
